...
echo ============================================================
echo BUSQUEDA DEBUG DE TEXTOS EN SistemaGestion.exe
echo ============================================================
echo.
