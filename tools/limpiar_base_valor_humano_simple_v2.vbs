' Limpieza simple v2 de datos demo en Valor Humano\Personal.mdb.
' Ejecutar con doble clic. No requiere BAT.
' Crea respaldo automatico antes de limpiar.
' V2 evita limite de continuacion de lineas de VBScript.
...
stamp = Timestamp()
backupPath = respaldosPath & "\Personal_BACKUP_AUTO_ANTES_LIMPIEZA_SIMPLE_V2_" & stamp & ".mdb"
logPath = basePath & "\limpieza_simple_v2_valor_humano_" & stamp & ".txt"
...
outFile.WriteLine "LIMPIEZA SIMPLE V2 BASE VALOR HUMANO"
