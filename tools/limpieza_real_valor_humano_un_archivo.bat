...
set RUNTIME_VBS=%TEMP%\limpiar_base_valor_humano_runtime.vbs
set CSCRIPT32=C:\Windows\SysWOW64\cscript.exe

echo ============================================================
echo LIMPIEZA REAL DE DATOS DEMO - VALOR HUMANO - UN ARCHIVO
echo ============================================================
echo.
echo Este BAT es autonomo: no necesita descargar ningun VBS aparte.
echo.
echo ATENCION: eliminara datos demo de empleados, contratos,
echo liquidaciones, legajos, licencias, MTSS, pagos y relaciones.
echo.
echo Antes de borrar, creara un respaldo automatico en:
echo %BASE%\Respaldos
echo.
...
echo Revise el resultado y luego abra GNS Personal PRO.
echo.
pause
